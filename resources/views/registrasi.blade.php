...
<html>
    ...
    <body style="background-color: #2c53c6;">
                ...
                <div class="col-lg-4 col-12 col-sm-8 mt-5">
                    <div class="card" style="border-radius: 15px;">
                        ...
                        <div class="col-12 d-flex justify-content-center">
                            <h6 style="margin-top: -20px;">Inventaris Ketringan</h6>
                        </div>
                        <center>
                            <img style="width: 20%; height: 20%; margin-bottom: 17px; margin-top:10px;" src="{{ asset('img/sendok1.png') }}" />
                        </center>
